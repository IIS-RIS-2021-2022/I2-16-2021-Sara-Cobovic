...
public class BringToFrontCommand extends Command {
    ...
    public BringToFrontCommand(Shape shape, PnlDrawing pnlDrawing, DrawingModel drawingModel, int currentIndex) {
    ...
    public void doCommand() {
        ...
        drawingModel.getShapes().set(drawingModel.getShapes().size() - 1, shape);
        pnlDrawing.repaint();
