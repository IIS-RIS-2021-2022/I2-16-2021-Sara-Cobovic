...
public class ToFrontCommand extends Command {
    ...
    public ToFrontCommand(Shape shape, PnlDrawing pnlDrawing, DrawingModel drawingModel, int currentIndex) {
        super(shape, pnlDrawing, drawingModel);
        this.currentIndex = currentIndex;
    }

    public ToFrontCommand(Shape shape, PnlDrawing pnlDrawing, DrawingModel drawingModel) {
        super(shape, pnlDrawing, drawingModel);
